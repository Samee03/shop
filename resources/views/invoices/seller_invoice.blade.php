				...
				<td>
					@if (Auth::user()->user_type == 'seller')
						@if(Auth::user()->shop->logo != null)
							<img src="{{ Auth::user()->shop->logo }}" height="40" style="display:inline-block;">
						@else
							<img src="/frontend/images/logo/logo.png" height="40" style="display:inline-block;">
						@endif
					@else
						@if($generalsetting->logo != null)
							<img src="{{ $generalsetting->logo }}" height="40" style="display:inline-block;">
						@else
							<img src="/frontend/images/logo/logo.png" height="40" style="display:inline-block;">
						@endif
					@endif
